...
// eventPublisher implements the OrderEventPublisher interface
...
// NewEventPublisher creates a new Kafka event publisher for orders
...
func (p *eventPublisher) PublishOrderEvent(event *domain.OrderEvent) error {
